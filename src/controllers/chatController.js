...
exports.getMessages = async (req, res) => {
    try {
        ...
        console.log(`Fetching messages for ID: ${recipientId}, User: ${currentUserId}`);
...
exports.markMessagesAsRead = async (req, res) => {
    ...
    try {
        ...
        const updatedMessages = await Message.updateMany(
            { sender: recipientObjectId, recipient: userObjectId, status: 'Delivered' },
        ...
        if (io) {
            ...
            io.to(recipientId).emit('messagesRead', { recipientId: req.user.id, messages });
        }
